...
//	Variable/G gWhichCom = 1
	...
	Variable/G gSeqRepeats = ards.wSeqDefaults[0][0]
	Variable/G gSeqDuration = ards.wSeqDefaults[1][0]
	Variable/G gSeqInterval = ards.wSeqDefaults[2][0]
	Variable/G gWhichCom = ards.wSeqDefaults[3][0]
